                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-m-txt-l es-p15t es-p15b es-p15l">
                                                                                        <h1 style="font-family: 'playfair display', georgia, 'times new roman', serif; font-size: 22px; line-height: 150%;">Thank you! We have received your registration.</h1>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15l">
                                                                                        <p style="font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif; font-size: 15px;">Dear Registrant,</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15t es-p10b es-p10r es-p15l">
                                                                                        <p style="font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif; font-size: 15px;">Thank you for your registration to Online Python Workshop organised by IET PSB Academy On Campus. We will send you the confirmation details at a later date. The event details are as follows:</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10r es-p15l">
                                                                                        <p style="color: #666666; font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif; font-size: 15px;">Date &amp; Time: Thursday, July 9th, 2020 at 7:30 PM (SGT)<br>Duration: 1 hour and 45 minutes<br>Platform: Blackboard (link will be sent at a later date)</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15t es-p10r es-p15l">
                                                                                        <p style="font-family: roboto, 'helvetica neue', helvetica, arial, sans-serif; font-size: 15px;">If you have any questions, please do not hesitate to contact us via email at ietpsboc@gmail.com.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
